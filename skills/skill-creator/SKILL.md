---
name: "skill-creator"
description: "Creates new SKILLs for the workspace. Invoke when user wants to create a new skill, add a custom skill, set up a skill template, or asks how to create a skill."
---
...
1. **Directory**: `.agents/skills/<skill-name>/`
...
3. Create directory: `.agents/skills/<skill-name>/`
...
Then create `.agents/skills/code-reviewer/SKILL.md`:
