...
If the paper lacks information that affects framework drawing, S0 asks for author supplementation inside S0 and stops. If the user declines supplementation or explicitly chooses to proceed, S0 records `proceed_with_known_risks=true`, updates the risk register, and hands that risk to S1-S7.

The report anchors S1-S7. If it is missing, stale, or too shallow, repair S0 before S1 strategy or any image generation.
