...
The former generated web-page display layer has been removed. Codex, ChatGPT web, Claude Code, and other environments should use normal text replies plus direct Markdown image embeds for saved atlas/category boards.
