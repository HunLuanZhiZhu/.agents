...
For S1/S2, sample broad directions across subtype, layout grammar, reader path, first-glance hook, and style lens. S1 candidate cards must include the full style-lens contract so S2 can generate sketches from explicit design logic.
