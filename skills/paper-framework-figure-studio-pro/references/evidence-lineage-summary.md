...
7. When multiple schemes are plausible, the skill should move toward generated candidate images or schematic candidates, usually 6 and never more than 8 for the first round. The default 6 should preserve diversity as 2 low-fidelity directions x 3 visual communication style treatments, instead of asking the user to compare only text or showing minor variants of one direction.

These claims are backed by the project-local evidence map summarized in this package.
