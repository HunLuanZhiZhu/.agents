...
- When multiple layout patterns are plausible, use low-fidelity sketches to preserve structural diversity. S1-FIGURE-STRATEGY prepares at least 8 S2 sketch candidate cards, and S2-SKETCH-EXPLORE defaults to 8 rough sketches; S5-CANDIDATE-IMAGE defaults to 6 formal candidates arranged as 2 structurally different directions x 3 visual communication style treatments, total max 8. Uploaded style references only inform S1-FIGURE-STRATEGY type advice and must not automatically add preference-informed extras.
